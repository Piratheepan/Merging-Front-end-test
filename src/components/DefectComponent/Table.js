...
'//file:///C:/Users/Romipraveen/img/Thuvarakan%20Karunakaran.jpg',

'//placekitten.com/4000/3000',

'//placekitten.com/800/1200',

'//localhost:8081/defect/downloadFile/Thuvarakan%20Karunakaran.jpg'
...
if(this.state.count<3){
  ...
  handleOkView = e => {
    console.log(e);
    axios.post('http://localhost:8081/defect/audit/', this.state.audit)
    .then(res => {
      console.log(res);
      console.log(res.data);
    });
