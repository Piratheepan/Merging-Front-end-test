...
class TableFilter extends React.Component {
  ...
  // }
  getComment = (id) => {
    axios.get('http://localhost:8081/defectservices/comments/' + id)
      .then(resp => {
        let Data = resp.data;
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, data = this.state.defect, record) => (
          <span>
            ...
            >
              <a href="#">
                <Icon type="delete" style={{ color: "red", fontSize: "18px" }} onClick={() => this.deleteDefect(data.defectId)} />
              </a>
            </Popconfirm>
          </span>
        ),
      ...
      },
      {
        ...
        render: (text, data = this.state.defect, record) => (
          <span>
            <Icon type="arrows-alt" style={{ fontSize: "18px", color: 'green' }} onClick={() => this.showModalView(data.defectId)} />
          </span>
        ),
